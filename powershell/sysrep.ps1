...
#user Format-Table to output the information with only the System Name and Version
...
#user Format-Table to output the information in a table and only include L1, L2, and L3 caches if they are present
$cpuInfo | Format-Table Name, Description, MaxClockSpeed, NumberOfCores, L1CacheSize -eq, L2CacheSize, L3CacheSize
